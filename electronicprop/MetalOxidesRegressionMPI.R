...
# Supplementary Material: MetalOxidesRegressionMPI.R                                                             #
##################################################################################################################
...
for (i in 1:list_responses.len) {
  ...
  # Results files
  KR.outfile.bw <- paste("mp_metaloxides_KR_bw_",response,".txt",sep="")
  KR.outfile.resid <- paste("mp_metaloxides_KR_resid_",response,".txt",sep="")
